...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-indigo-400 text-start text-base font-medium text-indigo-300 bg-gray-800 focus:outline-none focus:text-indigo-200 focus:bg-gray-700 focus:border-indigo-600 transition duration-150 ease-in-out'
